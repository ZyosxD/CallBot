        ...
        tools: [
          {
            ...
            description: "Schedule a technical assessment appointment. You must collect Contact Name, Company Name, Verified Phone, and Exact Time before calling this.",
            parameters: {
              type: "object",
              properties: {
          ...
          },
          {
            ...
            description: "Report the outcome of the interaction when the client is not interested, asks to call back later, or reaches a voicemail.",
            parameters: {
              type: "object",
              properties: {
          ...
          },
          {
            type: "function",
            name: "end_call",
            description: "Ends the current call. Use this at the very end of the conversation.",
            parameters: {
              type: "object",
              properties: {},
            }
  ...
  async handleFunctionCall(event) {
    ...
    try {
      if (name === 'schedule_appointment') {
        ...
        // Resolve tool call immediately to prevent hang
        this.sendToOpenAI({
            type: 'conversation.item.create',
            item: {
                type: 'function_call_output',
