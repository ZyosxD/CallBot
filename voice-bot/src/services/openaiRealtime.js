...
export class OpenAIRealtimeService {
        ...
        tools: [
          {
            ...
            description: "Schedule a Technical Assessment appointment. Must collect contactName, companyName, verifiedPhone, and exactTime.",
            parameters: {
              type: "object",
              properties: {
          ...
          },
          {
            ...
            description: "Log an interaction if client is not interested, asks to call back, or voicemail reached.",
            parameters: {
              type: "object",
              properties: {
  ...
  async handleFunctionCall(event) {
    ...
    try {
      ...
      logger.error('Failed to parse function args:', e);
      parsedArgs = {};
    }
    ...
    try {
      if (name === 'schedule_appointment') {
        ...
        // Output resolution back to OpenAI
        ...
        // Trigger a response to say goodbye before closing
        ...
        return; // Early return because we handled resolution manually above
      }
