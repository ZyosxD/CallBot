        ...
        tools: [
          {
            ...
            description: "Schedule a Technical Assessment with a human specialist. Use this ONLY after collecting contactName, companyName, confirmedPhone, and appointmentTime (The Trifecta).",
            parameters: {
              type: "object",
              properties: {
                ...
                needs: { type: "string", description: "Optional notes or detected needs" }
              },
          ...
          },
          {
            ...
            description: "Report an interaction when the client is not interested, asks to call back later, or if it's a voicemail.",
            parameters: {
              type: "object",
              properties: {
  ...
  async handleFunctionCall(event) {
    ...
    try {
      try {
        ...
        logger.error(`Error parsing args for ${name}:`, parseError);
        parsedArgs = {};
      }
      ...
      if (name === 'schedule_appointment') {
        ...
        return; // Early return since we handled output
      }
